...
class Settings:
    """ Настройки для валидации.
        ...
        :validator:             Cсылка на функцию, которая будет
                                ...
                                Функция "по умолчанию" установливается в
                                модуле декораторов в объявлении декоратора.

        :is_replace_the_args:   Если True, то будет производиться замена
                                исходных значений полей аргументов на
                                экземпляры классов валидации.

        :is_replace_the_result: Если True, то будет производиться замена
                                значения результата на экземпляры классов
                                валидации.
        :extra:                 Словарь с дополнительными значениями,
                                который будет передаваться в
                                validator (например, можно
